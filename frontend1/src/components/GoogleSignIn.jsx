...
const buildGoogleRedirectUrl = (clientId, redirectUri) => {
...
const GoogleRedirectButton = ({ googleClientId }) => {
  ...
  const authUrl = useMemo(
    () => buildGoogleRedirectUrl(googleClientId, redirectUri),
  ...
  return (
    <button
      ...
      className="w-full py-3.5 px-6 bg-white/10 hover:bg-white/15 border border-white/20 active:scale-[0.98] transition-all duration-200 rounded-xl font-semibold text-white flex items-center justify-center gap-3 shadow-lg hover:shadow-xl hover:cursor-pointer"
...
const GoogleSignInButton = () => {
  ...
  return <GoogleRedirectButton googleClientId={googleClientId} />;
};
